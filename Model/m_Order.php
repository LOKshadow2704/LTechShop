     ...
     class modelOrder{
        function selectManagermentSalesOrder($userid){
            ...
            if($cn_Order->connect($connect)){
                $table = mysql_query("select o.IDDonHang,a.HoTen,a.DiaChi, a.DienThoai, o.NgayDat, do.TrangThaiThanhToan from donhang as o inner join chitietdonhang as do on o.IDDonHang=do.IDDonHang inner join taikhoan as a on a.IDTaiKhoan = o.IDNguoiMua where o.IDNguoiBan=".$userid." GROUP BY o.IDDonHang");
